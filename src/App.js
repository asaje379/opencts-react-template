...
import Input from './vendor/Components/Input';
import FormNexGen from './vendor/Components/FormNexGen';
    ...
    <div className={'App ' + theme}>
      <div className="p-5">
        ...
        <div className="m-5">
          ...
          <br />
          <Input min="4" type="number" required />
          <Input icon="pencil" upper required />
          <Input type="email" />
          <Input minLength="8" type="email" lg />
          <Input type="date" />
